...
StringBinding.prototype.attachElement = function() {
  ...
  this.element.on('change', this._inputListener, false);
};

StringBinding.prototype.detachElement = function() {
  this.element.off('change', this._inputListener, false);
};
...
StringBinding.prototype._getElementValue = function() {
  var value = this.element.getValue();
  // IE and Opera replace \n with \r\n. Always store strings as \n
  return value.replace(/\r\n/g, '\n');
};

StringBinding.prototype.update = function() {
  var value = this._get();
